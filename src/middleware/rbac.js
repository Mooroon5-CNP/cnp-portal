...
const PERMISSIONS = {
  ...
  'deployments:manage-team-access':   ['manager'],

  'k8s:pods:view-all':       ['devops'],
  'k8s:pods:view-own':       ['devops'],
  'k8s:pods:scale':          ['devops'],
  'k8s:pods:delete':         ['devops'],
  'k8s:quotas:view':         ['devops'],
  'k8s:quotas:modify':       ['devops'],
  'k8s:events:view':         ['devops'],
  'k8s:manifest:edit':       ['devops'],
  'k8s:manifest:approve':    ['manager'],
